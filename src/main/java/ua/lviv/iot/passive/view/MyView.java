...
public class MyView {
  ...
  public MyView() {
    ...
    menu.put("16", this::getAircraftsByAviacompanyId);
  ...
  public void showMenu() throws SQLException {
    ...
    if (userChoice.equals("1")) {
      System.out.println("6 - get aircrafts by aviacompany id");
    }
    System.out.println("\nEnter option: ");
    userChoice += SCANNER.next();
  ...
  private void getAircraftsByAviacompanyId() {
    System.out.println("Enter please aviacompany id you want to get aircrafts from: ");
    Integer aviacompanyId = SCANNER.nextInt();
    List<Aircraft> aircrafts = aircraftController.findByAviacompanyId(aviacompanyId);
    System.out.println("Here are your aircrafts related to aviacompany by id " + aviacompanyId + ":\n");
    for (Aircraft aircraft : aircrafts) {
      System.out.println(aircraft.toString() + "\n");
    }
  }
  ...
  private void createAircraft() throws SQLException {
    ...
    Integer aviacompanyId = SCANNER.nextInt();
    Aviacompany aviacompany = aviacompanyController.findOne(aviacompanyId);
    Aircraft aircraft = new Aircraft(modelName, type, yearsInUse, maxSeats, aviacompany);
  ...
  private void updateAircraft() throws SQLException {
    ...
    Integer aviacompanyId = SCANNER.nextInt();
    Aviacompany aviacompany = aviacompanyController.findOne(aviacompanyId);
    Aircraft aircraft = new Aircraft(id, modelName, type, yearsInUse, maxSeats, aviacompany);
  ...
  private void updateAirport() throws SQLException {
    ...
    Airport airport = new Airport(id, name, amountOfWorkers, city);
  ...
  private void updateAviacompany() throws SQLException {
    ...
    Aviacompany aviacompany = new Aviacompany(id, name, creationDate);
  ...
  private void updateFlight() throws SQLException {
    ...
    System.out.println("Enter please flight available seats: ");
    Integer availableSeats = SCANNER.nextInt();
    Flight flight = new Flight(id, fromAirportId, toAirportId, departureTime, arrivalTime, pilotId, aircraftId, isAvailable, aviacompanyId, availableSeats);
  ...
  private void getAllPilots() throws SQLException {
    ...
    System.out.println("Here are your pilots:\n");
  ...
  private void updatePilot() throws SQLException {
    ...
    Pilot pilot = new Pilot(id, surname, name, position);
